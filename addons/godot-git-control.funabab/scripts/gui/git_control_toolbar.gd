...
onready var items_cat = [
	{
		ITEM_REFRESH: Lang.find_tr("item_refresh")
	},

	{
		ITEM_CHECKOUT_BRANCH: Lang.find_tr("item_checkout_branch"),
		ITEM_DELETE_BRANCH: Lang.find_tr("item_delete_branch")
	},

	{
		ITEM_COMMIT_ALL: Lang.find_tr("item_commit_all"),
		ITEM_REVERT_ALL: Lang.find_tr("item_revert_all"),
	},

	{
		ITEM_CREATE_BRANCH: Lang.find_tr("item_create_branch"),
		ITEM_MERGE_BRANCH: Lang.find_tr("item_merge_branch"),
		ITEM_REBASE_BRANCH: Lang.find_tr("item_rebase_branch")
	},

	{
		ITEM_TAG: Lang.find_tr("item_tag")
	},

	{
		ITEM_GITIGNORE_MANAGER: Lang.find_tr("item_gititnore_manager"),
		ITEM_SETTINGS: Lang.find_tr("item_settings")
	},

	{
		ITEM_LAUNCH_TERMINAL: Lang.find_tr("node_text_launch_terminal_btn")
	}
]
